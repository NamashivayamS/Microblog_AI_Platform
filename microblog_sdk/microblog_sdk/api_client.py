...
from microblog_sdk.configuration import Configuration
from microblog_sdk.api_response import ApiResponse, T as ApiResponseT
import microblog_sdk.models
from microblog_sdk import rest
from microblog_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(microblog_sdk.models, klass)
